...
impl ImageButton {
    pub fn new(texture_id: impl Into<TextureId>, size: impl Into<Vec2>, bg_fill: impl Into<Color32>) -> Self {
        let image = widgets::Image::new(texture_id, size).bg_fill(bg_fill.into());
        Self {
            image,
            sense: Sense::click(),
            frame: true,
